/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 5ffcebf2ecadd63e92d8a8ec509e3a19)
...
interface __BaseEnv_CloudflareEnv {
	...
	DB: D1Database;
	ASSETS: Fetcher;
	BETTER_AUTH_URL: "https://broad-sky-115b.<your-subdomain>.workers.dev" | "http://localhost:3000";
	NEXTJS_ENV: string;
...
declare namespace Cloudflare {
	interface ProductionEnv {
		...
		DB: D1Database;
		ASSETS: Fetcher;
		BETTER_AUTH_URL: "https://broad-sky-115b.<your-subdomain>.workers.dev";
		NEXTJS_ENV: string;
		BETTER_AUTH_SECRET: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "NEXTJS_ENV" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
